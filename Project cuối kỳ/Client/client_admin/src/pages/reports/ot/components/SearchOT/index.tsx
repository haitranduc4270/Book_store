...
import type { TypeListProject } from '@/pages/projects/data'
...
const SearchOT: FC<Props> = ({ dispatch, dataTable, setCondition }) => {
  ...
  const dataProject = dataTable.data?.map((item: any) => ({
    key: item._id,
    label: item.name,
    value: item._id,
  }))
