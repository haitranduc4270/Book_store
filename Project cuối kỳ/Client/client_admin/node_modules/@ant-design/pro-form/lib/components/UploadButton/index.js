...
var BaseProFormUploadButton = function BaseProFormUploadButton(_ref, ref) {
  ...
  var fieldProps = _ref.fieldProps,
      ...
      max = _ref.max,
      _ref$icon = _ref.icon,
      icon = _ref$icon === void 0 ? (0, _jsxRuntime.jsx)(_icons.UploadOutlined, {}) : _ref$icon,
  ...
  return (0, _jsxRuntime.jsx)(_upload.default, (0, _objectSpread2.default)((0, _objectSpread2.default)({
    action: action,
    accept: accept,
    ref: ref,
    ...
    children: showUploadButton && (isPictureCard ? (0, _jsxRuntime.jsxs)("span", {
      children: [icon, " ", title]
    }) : (0, _jsxRuntime.jsxs)(_button.default, (0, _objectSpread2.default)((0, _objectSpread2.default)({
...
var _default = ProFormUploadButton;
