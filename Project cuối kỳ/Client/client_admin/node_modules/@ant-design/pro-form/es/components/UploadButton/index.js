...
var BaseProFormUploadButton = function BaseProFormUploadButton(_ref, ref) {
  ...
  var fieldProps = _ref.fieldProps,
      ...
      max = _ref.max,
      _ref$icon = _ref.icon,
      icon = _ref$icon === void 0 ? _jsx(UploadOutlined, {}) : _ref$icon,
  ...
  return _jsx(_Upload, _objectSpread(_objectSpread({
    action: action,
    accept: accept,
    ref: ref,
    ...
    children: showUploadButton && (isPictureCard ? _jsxs("span", {
      children: [icon, " ", title]
    }) : _jsxs(_Button, _objectSpread(_objectSpread({
