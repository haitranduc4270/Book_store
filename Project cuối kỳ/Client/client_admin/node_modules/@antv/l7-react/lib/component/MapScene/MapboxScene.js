...
var MapboxScene = /*#__PURE__*/_react.default.memo(function (props) {
  var style = props.style,
      className = props.className,
      map = props.map,
      option = props.option,
      onSceneLoaded = props.onSceneLoaded;
  var container = /*#__PURE__*/(0, _react.createRef)();

  var _useState = (0, _react.useState)(),
      _useState2 = _slicedToArray(_useState, 2),
      scene = _useState2[0],
      setScene = _useState2[1]; // 地图初始
  ...
  return /*#__PURE__*/_react.default.createElement(_SceneContext.SceneContext.Provider, {
    value: scene
