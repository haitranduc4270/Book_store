  ...
  _createClass(PopupComponet, [{
    ...
    value: function componentDidMount() {
      ...
      var _this$props = this.props,
          ...
          lngLat = _this$props.lngLat;
      var p = new _l.Popup(_objectSpread(_objectSpread({}, option), {}, {
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (positionChanged) {
        ...
        this.popup.remove();
        this.popup = new _l.Popup(_objectSpread(_objectSpread({}, this.props.option), {}, {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(_SceneContext.SceneContext.Consumer, // @ts-ignore
      {}, function (scene) {
        if (scene) {
          _this2.scene = scene;
        }

        return /*#__PURE__*/(0, _reactDom.createPortal)(_this2.props.children, _this2.el);
      });
    }
  }]);
