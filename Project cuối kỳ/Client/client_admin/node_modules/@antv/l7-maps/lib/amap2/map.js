...
var AMAP_VERSION = '2.0.5';
var AMAP_SCRIPT_ID = 'amap-script';
var amapLoaded = false;
var pendingResolveQueue = [];
var AMapService = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_l7Core.TYPES.IGlobalConfigService), _dec3 = (0, _inversify.inject)(_l7Core.TYPES.MapConfig), _dec4 = (0, _inversify.inject)(_l7Core.TYPES.ICoordinateSystemService), _dec5 = (0, _inversify.inject)(_l7Core.TYPES.IEventEmitter), _dec(_class = (_class2 = function () {
  function AMapService() {
    var _this = this;

    (0, _classCallCheck2.default)(this, AMapService);
    (0, _defineProperty2.default)(this, "version", _version.Version['GAODE2.x']);
    ...
    (0, _defineProperty2.default)(this, "sceneCenterMKT", void 0);
    ...
    (0, _defineProperty2.default)(this, "handleViewChanged", function (e) {
  ...
  (0, _createClass2.default)(AMapService, [{
    ...
    value: function lngLatToCoordByLayer(lnglat, layerCenter) {
      var layerCenterFlat = _l7Utils.amap2Project.apply(void 0, (0, _toConsumableArray2.default)(layerCenter));

      return this._sub((0, _l7Utils.amap2Project)(lnglat[0], lnglat[1]), layerCenterFlat);
    }
  }, {
    ...
    value: function getCenter(options) {
      if (options !== null && options !== void 0 && options.padding) {
        ...
        var _this$getSize = this.getSize(),
            _this$getSize2 = (0, _slicedToArray2.default)(_this$getSize, 2),
            w = _this$getSize2[0],
            h = _this$getSize2[1];
              ...
              case 0:
                ...
                return new Promise(function (resolve) {
                  var resolveMap = function resolveMap() {
                    if (mapInstance) {
                      var _this4$map$customCoor;

                      _this4.map = mapInstance;
                      _this4.$mapContainer = _this4.map.getContainer();

                      var mapInitCenter = _this4.map.getCenter();

                      (_this4$map$customCoor = _this4.map.customCoords) === null || _this4$map$customCoor === void 0 ? void 0 : _this4$map$customCoor.setCenter([mapInitCenter.lng, mapInitCenter.lat]);

                      _this4.setCustomCoordCenter([mapInitCenter.lng, mapInitCenter.lat]);

                      setTimeout(function () {
                        _this4.map.on('viewchange', _this4.handleViewChanged);

                        resolve();
                      }, 30);
                    } else {
                      _this4.$mapContainer = _this4.creatAmapContainer(id);

                      var mapConstructorOptions = _objectSpread({
                        mapStyle: _this4.getMapStyle(style),
                      ...
                      var map = new AMap.Map(_this4.$mapContainer, mapConstructorOptions);
                      _this4.map = map;
                      ...
                      _this4.setCustomCoordCenter([_mapInitCenter.lng, _mapInitCenter.lat]);

                      map.on('viewchange', _this4.handleViewChanged);
                      setTimeout(function () {
                        resolve();
                      }, 10);
                    }
                  ...
                  _this4.viewport = new _Viewport.default();

                  if (!amapLoaded && !mapInstance) {
                    if (token === AMAP_API_KEY) {
                      console.warn(_this4.configService.getSceneWarninfo('MapToken'));
                    }
